...
const ITEMS = [
  { href: "/cubes/creators", label: "Manifesto", exact: true },
  { href: "/cubes/creators/discover", label: "Discover" },
  { href: "/cubes/creators/studio", label: "Studio" },
  { href: "/cubes/creators/assistant", label: "Assistant" },
  { href: "/cubes/creators/analytics", label: "Analytics" },
];
