...
const ITEMS = [
  { href: "/cubes/reflection", label: "Manifesto", exact: true },
  { href: "/cubes/reflection/report", label: "Report" },
  { href: "/cubes/reflection/timeline", label: "Timeline" },
  { href: "/cubes/reflection/archive", label: "Archive" },
];
