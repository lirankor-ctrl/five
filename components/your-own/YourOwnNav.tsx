...
const ITEMS = [
  { href: "/cubes/your-own", label: "Manifesto", exact: true },
  { href: "/cubes/your-own/marketplace", label: "Marketplace" },
  { href: "/cubes/your-own/build", label: "Build" },
];

export function YourOwnNav() {
