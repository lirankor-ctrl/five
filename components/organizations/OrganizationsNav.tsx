...
const ITEMS = [
  { href: "/cubes/organizations", label: "Manifesto", exact: true },
  { href: "/cubes/organizations/console", label: "Console" },
  { href: "/cubes/organizations/analytics", label: "Analytics" },
  { href: "/cubes/organizations/research", label: "Research" },
];
  ...
  return (
    <div className="border-b border-line/60 bg-paper">
      <nav className="mx-auto flex max-w-6xl flex-wrap items-center gap-1 px-6 py-4 text-xs font-light uppercase tracking-[0.2em] md:px-10">
        <Link
          href="/cubes"
          className="mr-3 text-ink-mute hover:text-ink"
        >
          ← cubes
        </Link>
